...
for subj_path in subj_paths:
    ...
    if os.path.exists(os.path.join(subj_path, predix + subj_id_num + "_t1ce.nii.gz")):
        subj_dict["T1c"] = os.path.join(
            subj_path, predix + subj_id_num + "_t1ce.nii.gz"
        )
    ...
    if os.path.exists(os.path.join(subj_path, predix + subj_id_num + "_flair.nii.gz")):
        subj_dict["T2_FLAIR"] = os.path.join(
            subj_path, predix + subj_id_num + "_flair.nii.gz"
        )
...
for fold in range(5):
    ...
    save_data_txt_3d(
        "../data/fold_BraTS_3d_" + str(fold) + "_train_noval.txt", subj_id_list_train
    )
    save_data_txt_3d(
        "../data/fold_BraTS_3d_" + str(fold) + "_val_noval.txt", subj_id_list_val
    )
    save_data_txt_3d(
        "../data/fold_BraTS_3d_" + str(fold) + "_test_noval.txt", subj_id_list_test
    )
